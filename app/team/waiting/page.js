...
export default function WaitingPage() {
 ...
 ╚═╝     ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝`}</pre>
                ...
                <div className="text-terminal-green text-2xl font-bold glow-text mb-1 sm:hidden">PARAALLAX</div>
                ...
                <div className="border border-terminal-border rounded p-4 mb-6 bg-black/40">
                    ...
                    {tid && (
                        <div className="text-terminal-muted text-xs">
                            TEAM ID: <span className="text-terminal-green font-bold">{tid}</span>
                        </div>
                    )}
                </div>
