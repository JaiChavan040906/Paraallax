...
const puzzleData = {
  ...
  name: 'ETHANOL',
  formula: 'CH₃CH₂OH',
  altNames: ['ethanol', 'ch3ch2oh', 'c2h5oh', 'ethyl alcohol'],
  level: 'LEVEL 01',
  method: 'GC-MS + IR',
  hint1: 'The molecular ion peak gives you the molecular weight. What simple alcohol has MW = 46?',
  hint2: 'A broad IR absorption near 3300 cm⁻¹ means an O-H group. Combined with MW=46 and a CH₃ fragment, this is a 2-carbon alcohol.',
  desc: 'A simple 2-carbon molecule. One functional group present.',
  gcms: {
    title: 'MASS SPECTRUM — Unknown Sample #A01',
    mz: [15, 29, 31, 45, 46],
    intensity: [55, 70, 100, 25, 18],
    basePeak: 31,
  },
  ir: {
    title: 'INFRARED SPECTRUM — Sample #A01',
    peaks: [
      { wn: 3350, T: 18, label: 'Broad' },
      { wn: 2960, T: 35, label: '' },
      { wn: 1450, T: 55, label: '' },
      { wn: 1050, T: 22, label: '' },
    ]
  ...
  tableData: [
    { mz: 46, intensity: 18, note: 'Molecular ion M⁺' },
    { mz: 45, intensity: 25, note: 'M-1 (loss of H)' },
    { mz: 31, intensity: 100, note: 'Base peak' },
    { mz: 29, intensity: 70, note: 'Fragment ion' },
    { mz: 15, intensity: 55, note: 'Fragment ion' },
  ],
  clues: [
    { label: 'Molecular Weight', value: '46 g/mol' },
    { label: 'Base Peak (m/z)', value: '31' },
    { label: 'IR: Broad 3350 cm⁻¹', value: 'Strong absorption' },
    { label: 'IR: C-O stretch ~1050 cm⁻¹', value: 'Strong absorption' },
    { label: 'Boiling Point', value: '78.4 °C' },
  ]
};

export default function Game9Set1({ puzzle, onSubmit, submitting }) {
