...
const puzzleData = {
  ...
  name: 'ACETIC ACID',
  formula: 'CH₃COOH',
  altNames: ['acetic acid', 'ethanoic acid', 'ch3cooh', 'c2h4o2', 'methanecarboxylic acid', 'glacial acetic acid'],
  level: 'LEVEL 03',
  method: 'GC-MS + IR',
  hint1: 'The very broad IR band from 2500-3300 combined with a sharp peak at 1715 means a carboxylic acid.',
  hint2: 'A molecular weight of 60 and fragments at 43 and 45 match a simple 2-carbon carboxylic acid.',
  desc: 'A simple carboxylic acid that gives vinegar its sour taste and pungent smell.',
  gcms: {
    title: 'MASS SPECTRUM — Unknown Sample #C03',
    mz: [15, 43, 45, 60],
    intensity: [30, 100, 85, 55],
    basePeak: 43,
  },
  ir: {
    title: 'INFRARED SPECTRUM — Sample #C03',
    peaks: [
      { wn: 3000, T: 25, label: 'Very Broad' },
      { wn: 1715, T: 10, label: 'Sharp' },
      { wn: 1410, T: 40, label: '' },
      { wn: 1280, T: 30, label: '' },
    ]
  },
  tableData: [
    { mz: 60, intensity: 55, note: 'Molecular ion M⁺' },
    { mz: 45, intensity: 85, note: 'M-15 (loss of CH₃)' },
    { mz: 43, intensity: 100, note: 'Base peak (loss of OH)' },
    { mz: 15, intensity: 30, note: 'Fragment ion (CH₃⁺)' },
  ],
  clues: [
    { label: 'Molecular Weight', value: '60 g/mol' },
    { label: 'Base Peak (m/z)', value: '43' },
    { label: 'IR: Very Broad 2500-3300', value: 'Strong absorption' },
    { label: 'IR: Sharp ~1715 cm⁻¹', value: 'Strong absorption' },
    { label: 'Boiling Point', value: '118.1 °C' },
  ]
};

export default function Game9Set3({ puzzle, onSubmit, submitting }) {
