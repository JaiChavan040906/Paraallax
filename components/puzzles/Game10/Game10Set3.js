...
const RECIPES = [
    ...
    {
        // Iron Ingot (Smelt center slot 4 / B2)
        pattern: [
            null, null, null,
            null, 'Iron Ore', null,
            null, null, null
    ...
    {
        // Bucket (L-shape small)
        pattern: [
            null, null, null,
            'Iron Ingot', null, null,
            'Iron Ingot', 'Iron Ingot', null
        ],
        tempReq: 20,
        result: 'Bucket'
    },
    {
        // Iron Pickaxe (Horizontal Bottom)
        pattern: [
            null, null, null,
            null, null, null,
...
export default function Game10Set3({ puzzle, onSubmit, submitting }) {
    const [inventory, setInventory] = useState([
        { item: 'Cobblestone', count: 3 },
        { item: 'Stick', count: 15 },
        { item: 'Iron Ore', count: 12 },
    ...
    const checkRecipe = () => {
        ...
        setTimeout(() => {
            const matched = RECIPES.find(r => {
                ...
                const tempMatch = (r.tempReq === 20 && temperature < 100) || (r.tempReq === 1800 && temperature >= 1750 && temperature <= 1850);
    ...
    const crucibleBgColor = temperature < 100 ? '#18181b' : 
                            ...
                            temperature >= 1750 && temperature <= 1850 ? '#991b1b' : '#7f1d1d';

    return (
        <div className={styles.container}>
            <div className={styles.headerRow}>
                <h2 className={styles.title}>{puzzle?.title || "Anomalous Crafting Protocol (SET 3)"}</h2>
                <div className={styles.badge}>CRUCIBLE 10-C</div>
            </div>
                ...
                <div className={styles.rightPanel}>
                    ...
                    <div className={styles.controlsPanel}>
                        <div className={styles.temperatureControl}>
                            <span style={{fontWeight: 'bold', color: temperature >= 1750 && temperature <= 1850 ? '#fde047' : '#fff'}}>
