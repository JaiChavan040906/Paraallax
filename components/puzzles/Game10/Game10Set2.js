...
const RECIPES = [
    ...
    {
        // Iron Ingot (Smelt internal slot 6 / A3)
        pattern: [
            null, null, null,
            null, null, null,
            'Iron Ore', null, null
...
export default function Game10Set2({ puzzle, onSubmit, submitting }) {
    const [inventory, setInventory] = useState([
        { item: 'Cobblestone', count: 5 },
        { item: 'Stick', count: 10 },
        { item: 'Iron Ore', count: 10 },
        { item: 'Diamond Ore', count: 5 } 
    ]);
    ...
    const checkRecipe = () => {
        ...
        setTimeout(() => {
            const matched = RECIPES.find(r => {
                ...
                const tempMatch = (r.tempReq === 20 && temperature < 100) || (r.tempReq === 1200 && temperature >= 1150 && temperature <= 1250);
    ...
    const crucibleBgColor = temperature < 100 ? '#18181b' : 
                            ...
                            temperature >= 1150 && temperature <= 1250 ? '#ea580c' : '#7f1d1d';

    return (
        <div className={styles.container}>
            <div className={styles.headerRow}>
                <h2 className={styles.title}>{puzzle?.title || "Anomalous Crafting Protocol (SET 2)"}</h2>
                <div className={styles.badge}>CRUCIBLE 10-B</div>
            </div>
                ...
                <div className={styles.rightPanel}>
                    ...
                    <div className={styles.controlsPanel}>
                        <div className={styles.temperatureControl}>
                            <span style={{fontWeight: 'bold', color: temperature >= 1150 && temperature <= 1250 ? '#fde047' : '#fff'}}>
