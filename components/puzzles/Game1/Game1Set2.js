...
export default function Game1Set2({ puzzle, onSubmit, submitting }) {
    const inputs = [false, false, true, true, false, true, true, false, false, true];
    ...
    return (
        <div className={styles.container}>
            <div className={styles.headerRow}>
                ...
                <div className={styles.badge}>GRID Beta</div>
            </div>
