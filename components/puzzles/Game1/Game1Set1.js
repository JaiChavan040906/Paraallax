...
export default function Game1Set1({ puzzle, onSubmit, submitting }) {
    const inputs = [true, true, false, true, true, false, false, false, true, false];
    ...
    return (
        <div className={styles.container}>
            <div className={styles.headerRow}>
                ...
                <div className={styles.badge}>GRID Alpha</div>
            </div>
